...
def seed_data():
    ...
    try:
        # Kiểm tra nếu đã có Restaurant hoặc User thì bỏ qua để tránh trùng email
        ...
        customer = User(full_name="Nguyễn Thực Khách", email="customer@what2eat.com", password_hash=hashed_pw, role="CUSTOMER")
        ...
        restaurants = [
            Restaurant(
                ...
                open_hours={"mon": {"open": "06:00", "close": "10:00"}}, 
                images=["https://images.unsplash.com/photo-1628294895950-9805252327bc"],
                cuisine_type="Phở", price_range="mid", status="APPROVED"
            ),
            Restaurant(
                owner_id=owner.user_id, 
                name="Cơm Tấm Ba Ghiền", 
                address="84 Đặng Văn Ngữ, Phú Nhuận, TP.HCM", 
                latitude=10.793836, longitude=106.664875,
                phone="0987654321", 
                description="Sườn nướng than hoa.", 
                open_hours={"mon": {"open": "07:00", "close": "21:00"}},
                images=["https://images.unsplash.com/photo-1626804475297-41609ea004eb"],
                cuisine_type="Cơm", price_range="mid", status="APPROVED"
            )
        ]
        ...
        capacities = [
            Capacity(restaurant_id=restaurants[0].restaurant_id, day_of_week=1, 
                     start_time=time(6, 0), end_time=time(10, 0), max_capacity=40),
            Capacity(restaurant_id=restaurants[1].restaurant_id, day_of_week=1, 
                     start_time=time(7, 0), end_time=time(21, 0), max_capacity=60)
        ]
