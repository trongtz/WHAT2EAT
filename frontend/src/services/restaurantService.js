...
export const normalizeRestaurant = (restaurant) => {
  ...
  return {
    ...
    distance: restaurant.distance ?? (restaurant.distance_km ? `${Number(restaurant.distance_km).toFixed(1)} km` : ""),
    matchScore: restaurant.match_score ?? restaurant.matchScore,
    aiReason: restaurant.reason ?? restaurant.aiReason,
    menu,
    reviewsList,
    reviews: reviewCount,
